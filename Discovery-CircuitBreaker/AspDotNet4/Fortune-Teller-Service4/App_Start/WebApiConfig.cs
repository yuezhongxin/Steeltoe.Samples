    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute(
                name: "ServicesHystrixApi",
                routeTemplate: "api/services/hystrix",
                defaults: new { controller = "Fortunes", action = "GetServicesWithHystrix" }
            );
            config.Routes.MapHttpRoute(
                name: "ServicesApi",
                routeTemplate: "api/services",
                defaults: new { controller = "Fortunes", action = "GetServices" }
            );
